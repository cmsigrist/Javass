...
public final class LocalMain extends Application {
    ...
    @Override public void start(Stage primaryStage) throws Exception {
        ...
        if(args.size() != ARG_SIZE && args.size() != ARG_SIZE_WITH_SEED) {
            String help = "Utilisation: java ch.epfl.javass.LocalMain <j1>…<j4> [<graine>] où " +
     ...
     * client (it throws an UncheckedIOException), we catch the exception, stop the program an write
